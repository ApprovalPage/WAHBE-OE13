...
lib.ssMetadata = [
		{name:"So_confusing_Display_SPA_300x600_atlas_P_1", frames: [[462,445,172,60],[0,445,460,182],[0,0,600,286],[0,288,600,155]]},
		{name:"So_confusing_Display_SPA_300x600_atlas_NP_1", frames: [[0,0,600,1200],[0,1202,600,644]]}
];
...
(lib.Arrows300x600 = function() {
	this.initialize(ss["So_confusing_Display_SPA_300x600_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib.WAHBEbkgd300x600 = function() {
	this.initialize(ss["So_confusing_Display_SPA_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.Soconfusing_Display_SPA_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},35).wait(173));

	// HEAD1b
	this.instance_1 = new lib.HEAD1b();
	this.instance_1.setTransform(150,88,1,1,0,0,0,110,58);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(35).to({_off:false},0).to({_off:true},74).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(67).to({_off:false},0).to({_off:true},42).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(109).to({_off:false},0).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(135).to({_off:false},0).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(168).to({_off:false},0).to({y:404,mode:"synched",startPosition:0},6).to({y:396},10,cjs.Ease.quadOut).to({y:404},6).to({y:396},10,cjs.Ease.quadOut).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(168).to({_off:false},0).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(109).to({_off:false},0).wait(99));

	// puzz
	this.instance_8 = new lib.WAHBEbkgdpuzz300x600();
	this.instance_8.setTransform(0,278,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},109).wait(99));

	// BKGD
	this.instance_9 = new lib.WAHBEbkgd300x600();
	this.instance_9.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(208));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-133.6,300,433.6,300);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/So_confusing_Display_SPA_300x600_atlas_P_1.png", id:"So_confusing_Display_SPA_300x600_atlas_P_1"},
		{src:"images/So_confusing_Display_SPA_300x600_atlas_NP_1.jpg", id:"So_confusing_Display_SPA_300x600_atlas_NP_1"}
	],
	preloads: []
};
