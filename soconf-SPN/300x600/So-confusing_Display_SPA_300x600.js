...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},47).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(47).to({_off:false},0).to({_off:true},86).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(91).to({_off:false},0).to({_off:true},42).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(159).to({_off:false},0).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(192).to({_off:false},0).to({y:404,mode:"synched",startPosition:0},6).to({y:396},10,cjs.Ease.quadOut).to({y:404},6).to({y:396},10,cjs.Ease.quadOut).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(192).to({_off:false},0).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(133).to({_off:false},0).wait(99));

	// puzz
	this.instance_8 = new lib.WAHBEbkgdpuzz300x600();
	this.instance_8.setTransform(0,278,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},133).wait(99));

	// BKGD
	this.instance_9 = new lib.WAHBEbkgd300x600();
	this.instance_9.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(232));
