...
lib.ssMetadata = [
		{name:"So_confusing_Display_SPA_728x90_atlas_P_1", frames: [[1064,157,172,60],[602,157,460,182],[0,1202,1456,180],[602,0,600,155],[0,0,600,1200]]},
		{name:"So_confusing_Display_SPA_728x90_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90paper = function() {
	this.initialize(ss["So_confusing_Display_SPA_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.Arrows300x600 = function() {
	this.initialize(ss["So_confusing_Display_SPA_728x90_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.WAHBECLINEoptSPN728x90 = function() {
	this.initialize(ss["So_confusing_Display_SPA_728x90_atlas_P_1"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(88.625,95.35);
	...
	this.shape_1.setTransform(73.8,89.275);
	...
	this.shape_2.setTransform(53.85,86.225);
	...
	this.shape_3.setTransform(34.475,89.125);
	...
	this.shape_4.setTransform(14.575,89.275);
	...
	this.shape_5.setTransform(0.55,85.825);
	...
	this.shape_6.setTransform(-13.875,86.225);
	...
	this.shape_7.setTransform(-38.975,89.125);
	...
	this.shape_8.setTransform(-63.975,89.275);
	...
	this.shape_9.setTransform(-81.575,89.275);
	...
	this.shape_10.setTransform(102.325,53.125);
	...
	this.shape_11.setTransform(82.425,50.125);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#1B3769").s().p("AgOBjQgMgFgIgNQgGgMgBgYIAAhGIgVAAIAAgYIAbgTIAPgkIAmAAIAAAjIAqAAIAAAsIgqAAIAABCQAAARAQAAIAOgCIAPgEIAAArIgVAHQgLADgQAAQgQgBgNgFg");
	this.shape_12.setTransform(66.65,51.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#1B3769").s().p("AglBXQgOgCgPgGIAAgvQARAHAQADQARAEAKAAQASAAAAgJQAAgEgEgCIgKgHIgWgJQgVgJgLgKQgKgMAAgVQgBgZAUgNQAUgNAeAAQASAAAOAEQAPAEAQAHIgQAmQgMgGgOgDQgNgEgHAAQgOAAAAAHQAAAEACACIAKAGIAWAIQAOAHAKAGQAKAHAEAJQAGAKAAAPQgBAQgHANQgHANgQAHQgQAHgZAAQgSAAgPgCg");
	this.shape_13.setTransform(51.65,53.275);
	...
	this.shape_14.setTransform(33.975,53.275);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#1B3769").s().p("AhBBhQgRgXAAgrQAAgrARgXQASgWAcAAQARAAAJAHQALAHAHALIABAAIgCgSIgBgWIAAguIA8AAIAADqIgsAAIgOgVIgCAAQgGAKgLAHQgKAHgSAAQgaAAgRgWgAgPAAQgHAKAAAWQAAAVAHAKQAHAKAKAAQAOAAAGgJQAGgKABgSIAAgFQgBgUgGgLQgFgKgPAAQgKAAgHAKg");
	this.shape_15.setTransform(7.2,50.225);
	...
	this.shape_16.setTransform(-12.25,53.425);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#1B3769").s().p("AgcB2IAAjrIA5AAIAADrg");
	this.shape_17.setTransform(-26.95,50.075);
	...
	this.shape_18.setTransform(-41.925,53.275);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#1B3769").s().p("AglBXQgOgCgPgGIAAgvQARAHAQADQARAEAKAAQASAAAAgJQAAgEgEgCIgKgHIgWgJQgVgJgLgKQgKgMAAgVQgBgZAUgNQAUgNAeAAQASAAAOAEQAPAEAQAHIgQAmQgMgGgOgDQgNgEgHAAQgOAAAAAHQAAAEACACIAKAGIAVAIQAPAHAKAGQAKAHAEAJQAGAKAAAPQgBAQgHANQgHANgQAHQgQAHgZAAQgSAAgPgCg");
	this.shape_19.setTransform(-58.6,53.275);
	...
	this.shape_20.setTransform(-82.875,53.275);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#1B3769").s().p("AhBBhQgRgXAAgrQAAgrASgXQARgWAcAAQARAAAKAHQAKAHAHALIABAAIgCgSIAAgWIAAguIA7AAIAADqIgtAAIgMgVIgCAAQgHAKgKAHQgLAHgRAAQgbAAgRgWgAgPAAQgHAKAAAWQAAAVAHAKQAGAKALAAQAOAAAGgJQAGgKAAgSIAAgFQAAgUgFgLQgGgKgQAAQgKAAgGAKg");
	this.shape_21.setTransform(-102.55,50.225);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#1B3769").s().p("AglBXQgOgCgPgGIAAgvQARAHAQADQARAEAKAAQASAAAAgJQAAgEgEgCIgKgHIgWgJQgVgJgLgKQgKgMAAgVQgBgZAUgNQAUgNAeAAQASAAAOAEQAPAEAQAHIgQAmQgMgGgOgDQgNgEgHAAQgOAAAAAHQAAAEACACIAKAGIAVAIQAPAHAKAGQAKAHAEAJQAGAKAAAPQgBAQgHANQgHANgQAHQgQAHgZAAQgSAAgPgCg");
	this.shape_22.setTransform(83.6,17.275);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#1B3769").s().p("AgsBOQgSgKgLgUQgLgUAAgcQgBgqAXgXQAYgXAmAAQAaAAATALQATAKAKATQAMAUAAAcQAAArgYAXQgXAXgnAAQgYAAgUgLgAgSggQgHALAAAVQAAAWAHALQAFAMANAAQAOAAAFgMQAHgLAAgWQAAgVgHgLQgFgMgOAAQgNAAgFAMg");
	this.shape_23.setTransform(66.2,17.275);
	...
	this.shape_24.setTransform(50.675,17.125);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#1B3769").s().p("Ag1BRQgOgHgIgOQgHgOAAgWIAAhuIA7AAIAABcQAAARAFAJQAFAJAKAAQAQAAAGgOQAGgNAAgZIAAhLIA6AAIAACqIgsAAIgIgVIgDAAQgIANgOAGQgNAFgQAAQgQAAgOgGg");
	this.shape_25.setTransform(32.7,17.425);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#1B3769").s().p("AgsB6QgQgCgOgFIAAgyQAPAGAOAEQAOADAUAAQAjAAAAgZIAAgDIACgWIgCAAQgHAKgKAIQgKAHgRAAQgcAAgRgWQgRgXAAgrQAAgrASgWQAQgYAdAAQARABAKAGQALAIAHAKIABAAIAFgVIAzAAIAACrQAAAjgWAUQgXASguAAQgUAAgQgCgAgWgiQAAAWAGALQAHAIALAAQAPAAAGgIQAFgJAAgSIAAgIQABgUgGgKQgFgMgRAAQgXAAAAAsg");
	this.shape_26.setTransform(12.75,20.85);
	...
	this.shape_27.setTransform(-6.475,17.275);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#1B3769").s().p("AglBXQgPgCgOgGIAAgvQAQAHARADQARAEAJAAQASAAAAgJQAAgEgCgCIgKgHIgXgJQgVgJgLgKQgLgMAAgVQABgZATgNQATgNAfAAQARAAAPAEQAPAEAQAHIgQAmQgNgGgNgDQgNgEgIAAQgNAAAAAHQAAAEADACIAIAGIAWAIQAPAHAKAGQAJAHAGAJQAEAKAAAPQABAQgIANQgHANgQAHQgQAHgZAAQgTAAgOgCg");
	this.shape_28.setTransform(-24,17.275);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#1B3769").s().p("AglBXQgPgCgOgGIAAgvQARAHAQADQARAEAJAAQATAAgBgJQAAgEgDgCIgJgHIgXgJQgWgJgKgKQgLgMABgVQAAgZATgNQAUgNAeAAQARAAAPAEQAPAEAQAHIgQAmQgNgGgNgDQgNgEgIAAQgNAAAAAHQAAAEACACIAJAGIAXAIQAOAHAKAGQAKAHAEAJQAFAKABAPQAAAQgIANQgHANgQAHQgQAHgZAAQgSAAgPgCg");
	this.shape_29.setTransform(-48.1,17.275);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#1B3769").s().p("AgsBOQgSgKgLgUQgLgUAAgcQAAgqAWgXQAXgXAnAAQAaAAASALQAUAKAKATQAMAUAAAcQAAArgYAXQgXAXgnAAQgYAAgUgLgAgTggQgFALgBAVQABAWAFALQAGAMANAAQAOAAAFgMQAHgLgBgWQABgVgHgLQgFgMgOAAQgNAAgGAMg");
	this.shape_30.setTransform(-66,17.275);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#1B3769").s().p("AhHBvIAAjdIA7AAIAACsIBVAAIAAAxg");
	this.shape_31.setTransform(-84.4,14.775);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD2, new cjs.Rectangle(-131.5,0,263,107), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3.setTransform(392.725,53.125);
	...
	this.shape_4.setTransform(372.825,53.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#642484").s().p("AgOBjQgMgFgIgNQgGgMAAgYIAAhGIgWAAIAAgYIAbgTIAPgkIAmAAIAAAjIAqAAIAAAsIgqAAIAABCQAAARAQAAIAPgCIANgEIAAArIgUAHQgLADgQAAQgQgBgNgFg");
	this.shape_5.setTransform(356.55,51.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#642484").s().p("AgrBOQgUgKgKgUQgMgUAAgcQAAgqAXgXQAYgXAnAAQAYAAAUALQASAKALATQALAUAAAcQABArgXAXQgYAXgnAAQgYAAgTgLgAgSggQgHALAAAVQAAAWAHALQAFAMAOAAQANAAAFgMQAHgLAAgWQAAgVgHgLQgFgMgOAAQgNAAgFAMg");
	this.shape_6.setTransform(327.55,53.275);
	...
	this.shape_7.setTransform(311.525,53.125);
	...
	this.shape_8.setTransform(293.775,53.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#642484").s().p("AhSB8IAAj0IAwAAIAJAVIACAAQAHgKAKgHQAKgIASAAQAdAAAQAYQAQAWAAArQAAAdgIATQgJAUgOAKQgOAKgSAAQgSAAgJgHQgKgGgGgHIgBAAIABANIAAAQIAAA+gAgRhDQgFAIgBATIAAAEQAAAVAFALQAFAJANABQALAAAGgJQAGgKAAgXQAAgXgGgIQgGgKgLAAQgMAAgFAKg");
	this.shape_9.setTransform(274.325,56.85);
	...
	this.shape_10.setTransform(246.825,57);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#642484").s().p("Ag1BRQgOgHgHgOQgJgOABgWIAAhuIA7AAIAABcQAAARAEAJQAFAJAMAAQAPAAAGgOQAFgNABgZIAAhLIA6AAIAACqIgsAAIgHgVIgEAAQgIANgOAGQgNAFgPAAQgRAAgOgGg");
	this.shape_11.setTransform(226.05,53.425);
	...
	this.shape_12.setTransform(199.925,53.125);
	...
	this.shape_13.setTransform(169.625,53.125);
	...
	this.shape_14.setTransform(151.875,53.275);
	...
	this.shape_15.setTransform(134.35,53.275);
	...
	this.shape_16.setTransform(109.925,53.125);
	...
	this.shape_17.setTransform(89.875,53.275);
	...
	this.shape_18.setTransform(70.7,50.225);
	...
	this.shape_19.setTransform(51.475,53.275);
	...
	this.shape_20.setTransform(32.05,53.425);
	...
	this.shape_21.setTransform(12.325,56.85);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#642484").s().p("AhBBhQgRgXAAgrQAAgrARgXQASgWAcAAQARAAAJAHQALAHAHALIABAAIgCgSIgBgWIAAguIA8AAIAADqIgsAAIgOgVIgCAAQgGAKgLAHQgKAHgSAAQgaAAgRgWgAgPAAQgHAKAAAWQAAAVAHAKQAHAKAKAAQAOAAAGgJQAGgKABgSIAAgFQgBgUgGgLQgFgKgPAAQgKAAgHAKg");
	this.shape_22.setTransform(319.05,14.225);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#642484").s().p("Ag1BRQgNgHgJgOQgIgOAAgWIAAhuIA8AAIAABcQAAARAEAJQAGAJAKAAQAQAAAGgOQAFgNAAgZIAAhLIA8AAIAACqIgtAAIgHgVIgEAAQgIANgOAGQgMAFgQAAQgRAAgOgGg");
	this.shape_23.setTransform(299.6,17.425);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#642484").s().p("AgdB2IAAjrIA7AAIAADrg");
	this.shape_24.setTransform(284.4,14.075);
	...
	this.shape_25.setTransform(268.925,17.275);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#642484").s().p("AglBXQgPgCgOgGIAAgvQARAHAQADQARAEAJAAQATAAAAgJQgBgEgDgCIgKgHIgWgJQgWgJgKgKQgKgMAAgVQAAgZATgNQAUgNAeAAQARAAAPAEQAPAEAQAHIgQAmQgNgGgNgDQgNgEgHAAQgOAAAAAHQAAAEACACIAJAGIAXAIQAOAHAKAGQAKAHAEAJQAGAKAAAPQAAAQgIANQgHANgQAHQgQAHgZAAQgSAAgPgCg");
	this.shape_26.setTransform(252.25,17.275);
	...
	this.shape_27.setTransform(225.975,17.275);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#642484").s().p("AhBBhQgRgXAAgrQAAgrASgXQARgWAcAAQARAAAKAHQAKAHAHALIABAAIgCgSIAAgWIAAguIA7AAIAADqIgtAAIgNgVIgBAAQgHAKgKAHQgLAHgRAAQgbAAgRgWgAgPAAQgHAKAAAWQAAAVAHAKQAGAKALAAQAOAAAGgJQAGgKAAgSIAAgFQAAgUgFgLQgGgKgQAAQgJAAgHAKg");
	this.shape_28.setTransform(205.8,14.225);
...
p.nominalBounds = new cjs.Rectangle(0,0,454.8,71);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#642484").s().p("AgVAWQgKgHAAgPQAAgPAKgHQAJgGANAAQAMAAAJAGQAKAHAAAPQAAAPgKAHQgJAHgMAAQgNAAgJgHg");
	this.shape.setTransform(265.075,59.35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#642484").s().p("AgVAWQgKgHAAgPQAAgPAKgHQAJgGANAAQAMAAAJAGQAKAHAAAPQAAAPgKAHQgJAHgMAAQgNAAgJgHg");
	this.shape_1.setTransform(253.475,59.35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#642484").s().p("AgVAWQgKgHAAgPQAAgPAKgHQAJgGANAAQAMAAAJAGQAKAHAAAPQAAAPgKAHQgJAHgMAAQgNAAgJgHg");
	this.shape_2.setTransform(241.875,59.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#642484").s().p("AAYBXIAAhcQAAgRgFgJQgFgJgKAAQgQAAgGAOQgGAOAAAYIAABLIg7AAIAAiqIAtAAIAIAWIACAAQAIgMANgGQAMgHATAAQAaAAARAPQARAPAAAhIAABug");
	this.shape_3.setTransform(227.625,53.125);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#642484").s().p("AhBBLQgPgNAAgdQAAgbATgMQATgOAkgBIAcgBIAAgDQAAgLgGgFQgFgFgKAAQgJAAgNAEIgZAJIgRgnQAPgIATgEQATgEAWAAQAgAAATAQQASAQAAAeIAABwIgpAAIgLgXIgCAAQgHAJgIAGQgHAGgJACQgKADgOAAQgWAAgPgOgAAJAKQgQAAgGAGQgHAFAAAJQAAAJAFAEQAEAEAIAAQAKAAAIgHQAHgHAAgLIAAgNg");
	this.shape_4.setTransform(207.725,53.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#642484").s().p("AgOBjQgNgFgGgNQgIgMAAgYIAAhGIgUAAIAAgYIAagTIAPgkIAmAAIAAAjIAqAAIAAAsIgqAAIAABCQAAARAQAAIAOgCIAPgEIAAArIgVAHQgLADgRAAQgPgBgNgFg");
	this.shape_5.setTransform(191.45,51.7);
	...
	this.shape_6.setTransform(169.625,53.125);
	...
	this.shape_7.setTransform(151.875,53.275);
	...
	this.shape_8.setTransform(134.35,53.275);
	...
	this.shape_9.setTransform(109.925,53.125);
	...
	this.shape_10.setTransform(89.875,53.275);
	...
	this.shape_11.setTransform(70.7,50.225);
	...
	this.shape_12.setTransform(51.475,53.275);
	...
	this.shape_13.setTransform(32.05,53.425);
	...
	this.shape_14.setTransform(12.325,56.85);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#642484").s().p("AhBBhQgRgXAAgrQAAgrARgXQASgWAcAAQARAAAJAHQALAHAHALIABAAIgCgSIgBgWIAAguIA8AAIAADqIgsAAIgOgVIgCAAQgGAKgLAHQgKAHgSAAQgaAAgRgWgAgPAAQgHAKAAAWQAAAVAHAKQAHAKAKAAQAOAAAGgJQAGgKABgSIAAgFQgBgUgGgLQgFgKgPAAQgKAAgHAKg");
	this.shape_15.setTransform(319.05,14.225);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#642484").s().p("Ag1BRQgNgHgJgOQgIgOAAgWIAAhuIA8AAIAABcQAAARAEAJQAGAJAKAAQAQAAAGgOQAFgNAAgZIAAhLIA8AAIAACqIgtAAIgHgVIgEAAQgIANgOAGQgMAFgQAAQgRAAgOgGg");
	this.shape_16.setTransform(299.6,17.425);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#642484").s().p("AgdB2IAAjrIA7AAIAADrg");
	this.shape_17.setTransform(284.4,14.075);
	...
	this.shape_18.setTransform(268.925,17.275);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#642484").s().p("AglBXQgPgCgOgGIAAgvQARAHAQADQARAEAJAAQATAAAAgJQgBgEgDgCIgKgHIgWgJQgWgJgKgKQgKgMAAgVQAAgZATgNQAUgNAeAAQARAAAPAEQAPAEAQAHIgQAmQgNgGgNgDQgNgEgHAAQgOAAAAAHQAAAEACACIAJAGIAXAIQAOAHAKAGQAKAHAEAJQAGAKAAAPQAAAQgIANQgHANgQAHQgQAHgZAAQgSAAgPgCg");
	this.shape_19.setTransform(252.25,17.275);
	...
	this.shape_20.setTransform(225.975,17.275);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#642484").s().p("AhBBhQgRgXAAgrQAAgrASgXQARgWAcAAQARAAAKAHQAKAHAHALIABAAIgCgSIAAgWIAAguIA7AAIAADqIgtAAIgNgVIgBAAQgHAKgKAHQgLAHgRAAQgbAAgRgWgAgPAAQgHAKAAAWQAAAVAHAKQAGAKALAAQAOAAAGgJQAGgKAAgSIAAgFQAAgUgFgLQgGgKgQAAQgJAAgHAKg");
	this.shape_21.setTransform(205.8,14.225);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(0,0,440.1,71), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("EgnVAGYIAMt3MAujAApIgMN3g");
	var mask_graphics_1 = new cjs.Graphics().p("EglhAGXIARt3MAuiAA4IgQN2g");
	var mask_graphics_2 = new cjs.Graphics().p("EgjtAGWIAVt2MAujABFIgVN3g");
	var mask_graphics_3 = new cjs.Graphics().p("Egh4AGRIAZt2MAuiABVIgZN2g");
	var mask_graphics_4 = new cjs.Graphics().p("EggEAGKIAet2MAuhABjIgdN2g");
	var mask_graphics_5 = new cjs.Graphics().p("A+PGDIAht2MAuiABxIgiN2g");
	var mask_graphics_6 = new cjs.Graphics().p("A8bF8IAmt2MAuhAB/IgmN2g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-251.8162,y:-47.9694}).wait(1).to({graphics:mask_graphics_1,x:-240.1868,y:-48.0582}).wait(1).to({graphics:mask_graphics_2,x:-228.5546,y:-48.1462}).wait(1).to({graphics:mask_graphics_3,x:-216.9207,y:-47.9007}).wait(1).to({graphics:mask_graphics_4,x:-205.2851,y:-47.3592}).wait(1).to({graphics:mask_graphics_5,x:-193.6476,y:-46.8177}).wait(1).to({graphics:mask_graphics_6,x:-182.0063,y:-46.3261}).wait(90).to({graphics:null,x:0,y:0}).wait(1));

	// Layer_1
	this.instance = new lib.WAHBECLINEoptSPN728x90();
	...
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("EgnSAG8IAAt3MAujAAAIAAN3g");
	var mask_1_graphics_7 = new cjs.Graphics().p("EglcAG8IAAt3MAukAAAIAAN3g");
	var mask_1_graphics_8 = new cjs.Graphics().p("EgjlAG8IAAt3MAujAAAIAAN3g");
	var mask_1_graphics_9 = new cjs.Graphics().p("EghvAG8IAAt3MAujAAAIAAN3g");
	var mask_1_graphics_10 = new cjs.Graphics().p("A/5G8IAAt3MAukAAAIAAN3g");
	var mask_1_graphics_11 = new cjs.Graphics().p("A+CG8IAAt3MAujAAAIAAN3g");
	var mask_1_graphics_12 = new cjs.Graphics().p("A8MG8IAAt3MAukAAAIAAN3g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:-251.525,y:36.625}).wait(1).to({graphics:mask_1_graphics_7,x:-239.6875,y:35.9583}).wait(1).to({graphics:mask_1_graphics_8,x:-227.85,y:35.2917}).wait(1).to({graphics:mask_1_graphics_9,x:-216.0125,y:34.625}).wait(1).to({graphics:mask_1_graphics_10,x:-204.175,y:33.9583}).wait(1).to({graphics:mask_1_graphics_11,x:-192.3375,y:33.2917}).wait(1).to({graphics:mask_1_graphics_12,x:-180.5,y:32.625}).wait(84).to({graphics:null,x:0,y:0}).wait(1));

	// Layer_1 copy
	this.instance_1 = new lib.WAHBECLINEoptSPN728x90();
	this.instance_1.setTransform(-364,-45,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-364,-45,301.6,90);
...
// stage content:
(lib.Soconfusing_Display_SPA_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(182).call(this.frame_182).wait(1));
	...
	this.instance_1.setTransform(107.5,63.35,0.7479,0.7479,0,0,0,110.1,58.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},23).wait(160));

	// HEAD1b
	this.instance_2 = new lib.HEAD1b();
	this.instance_2.setTransform(107.5,63.35,0.7479,0.7479,0,0,0,110.1,58.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(23).to({_off:false},0).to({_off:true},62).wait(98));

	// SUBHEAD
	this.instance_3 = new lib.SUBHEAD();
	this.instance_3.setTransform(576.3,135.3,0.81,0.81,0,0,0,0.4,111.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(43).to({_off:false},0).to({_off:true},42).wait(98));

	// HEAD2
	this.instance_4 = new lib.HEAD2();
	this.instance_4.setTransform(145.05,49.7,0.55,0.55,0,0,0,110.2,58);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(85).to({_off:false},0).wait(98));

	// C_LINE
	this.instance_5 = new lib.CLINE();
	this.instance_5.setTransform(364.2,45.05,1,1,0,0,0,0.2,0.2);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(111).to({_off:false},0).wait(72));

	// arrows
	this.instance_6 = new lib.Arrows("synched",0);
	this.instance_6.setTransform(379.95,20.45,0.68,0.68);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({y:25.85},6).to({y:20.45},10,cjs.Ease.quadOut).to({y:25.85},6).to({y:20.45},10,cjs.Ease.quadOut).wait(7));

	// CTA
	this.instance_7 = new lib.CTA();
	this.instance_7.setTransform(375.4,47.9,0.8,0.8);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(144).to({_off:false},0).wait(39));

	// LOGOs
	this.instance_8 = new lib.LOGOs();
	this.instance_8.setTransform(585,47.1,1.07,1.07);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(85).to({_off:false},0).wait(98));

	// puzz
	this.instance_9 = new lib.WAHBEpuzz300x600();
	this.instance_9.setTransform(329,-137,0.25,0.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true},85).wait(98));

	// BKGD
	this.instance_10 = new lib._728x90paper();
...
p.nominalBounds = new cjs.Rectangle(224.4,-92,503.6,255);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/So_confusing_Display_SPA_728x90_atlas_P_1.png", id:"So_confusing_Display_SPA_728x90_atlas_P_1"},
		{src:"images/So_confusing_Display_SPA_728x90_atlas_NP_1.jpg", id:"So_confusing_Display_SPA_728x90_atlas_NP_1"}
	],
	preloads: []
};
