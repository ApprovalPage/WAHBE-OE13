...
lib.ssMetadata = [
		{name:"WAHBE_soconf_160x600_atlas_P_1", frames: [[0,1445,172,60],[0,1359,459,84],[0,0,320,1200],[0,1202,600,155]]},
		{name:"WAHBE_soconf_160x600_atlas_NP_1", frames: [[0,0,600,1200],[0,1202,600,644]]}
];
...
(lib.Arrows300x600 = function() {
	this.initialize(ss["WAHBE_soconf_160x600_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib.WAHBEbkgd300x600 = function() {
	this.initialize(ss["WAHBE_soconf_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.WAHBEsoconf160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({y:404},6).to({y:396},10,cjs.Ease.quadOut).to({y:404},6).to({y:396},10,cjs.Ease.quadOut).wait(8));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WAHBE_soconf_160x600_atlas_P_1.png", id:"WAHBE_soconf_160x600_atlas_P_1"},
		{src:"images/WAHBE_soconf_160x600_atlas_NP_1.jpg", id:"WAHBE_soconf_160x600_atlas_NP_1"}
	],
	preloads: []
};
