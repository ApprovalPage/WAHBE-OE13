...
lib.ssMetadata = [
		{name:"WAHBE_soconf_300x250_atlas_P_1", frames: [[461,659,172,60],[0,659,459,84],[0,0,600,500],[0,502,600,155]]},
		{name:"WAHBE_soconf_300x250_atlas_NP_1", frames: [[0,0,600,500],[0,502,600,500]]}
];
...
(lib.Arrows300x600 = function() {
	this.initialize(ss["WAHBE_soconf_300x250_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib.WAHBEbkgdopt300x250 = function() {
	this.initialize(ss["WAHBE_soconf_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.WAHBEsoconf300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},85).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({y:130},6).to({y:122},10,cjs.Ease.quadOut).to({y:130},6).to({y:122},10,cjs.Ease.quadOut).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true},85).wait(99));

	// BKGD
	this.instance_10 = new lib.WAHBEbkgdopt300x250();
	this.instance_10.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(184));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WAHBE_soconf_300x250_atlas_P_1.png", id:"WAHBE_soconf_300x250_atlas_P_1"},
		{src:"images/WAHBE_soconf_300x250_atlas_NP_1.jpg", id:"WAHBE_soconf_300x250_atlas_NP_1"}
	],
	preloads: []
};
