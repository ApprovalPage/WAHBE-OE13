...
lib.ssMetadata = [
		{name:"HCA_soconf_300x50_atlas_P_1", frames: [[0,1504,172,60],[0,1359,459,84],[0,1445,300,57],[0,1202,600,155],[0,0,600,1200]]},
		{name:"HCA_soconf_300x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90paper = function() {
	this.initialize(ss["HCA_soconf_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.Arrows300x600 = function() {
	this.initialize(ss["HCA_soconf_300x50_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.HCAsoconf300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_7.setTransform(72.45,31.65,0.6351,0.6351,0,0,0,0.1,0.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HCA_soconf_300x50_atlas_P_1.png", id:"HCA_soconf_300x50_atlas_P_1"},
		{src:"images/HCA_soconf_300x50_atlas_NP_1.jpg", id:"HCA_soconf_300x50_atlas_NP_1"}
	],
	preloads: []
};
